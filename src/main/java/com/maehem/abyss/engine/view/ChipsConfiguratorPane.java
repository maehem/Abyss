/*
    ...
    under the License.
*/
package com.maehem.abyss.engine.view;
...
import com.maehem.abyss.engine.gui.widgets.chip.ChipDetailsPane;
import com.maehem.abyss.engine.gui.widgets.chip.ConfiguratorInventoryListView;
import com.maehem.abyss.engine.gui.widgets.chip.InstalledChipsGridPane;
...
public class ChipsConfiguratorPane extends ViewPane implements GameStateListener, ChipsConfigurationListener {
    ...
    public ChipsConfiguratorPane( GameState gs ) {  //, int w, int h) {
        ...
        details = new ChipDetailsPane(gs, VIEW_W, this);
        
        this.setPrefSize(ViewPane.WIDTH, ViewPane.HEIGHT);
        inventory = new ConfiguratorInventoryListView(gs, VIEW_W, gs.getPlayer(), this );
        installedChips = new InstalledChipsGridPane( gs,  VIEW_W, 2*VIEW_W/3, gs.getPlayer(), this);
