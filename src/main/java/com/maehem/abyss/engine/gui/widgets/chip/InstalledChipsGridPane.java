...
public class InstalledChipsGridPane extends GridPane {
    ...
    public InstalledChipsGridPane(GameState gs, double w, double h, Player p, ChipsConfigurationListener listener) {
        ...
        chip1 = new InstalledChipStatsPane(gs, player, 0);
        chip2 = new InstalledChipStatsPane(gs, player, 1);
        chip3 = new InstalledChipStatsPane(gs, player, 2);
        chip4 = new InstalledChipStatsPane(gs, player, 3);
