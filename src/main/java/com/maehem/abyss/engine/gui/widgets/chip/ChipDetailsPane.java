...
public class ChipDetailsPane extends HBox {
    ...
    public ChipDetailsPane(GameState gs, double w, ChipsConfigurationListener listener) {
        this.width = w;
    ...
    public final void updateChipDetails(SkillChipThing t, Player p) {
        if (t != null) {
            ...
            if ( iconPath.startsWith("/content") ) {
                ...
                imgStream = getClass().getResourceAsStream(t.getIconPath());
            }
            ...
            boolean chipIsInventory = p.getInventory().contains(t);
