...
import com.maehem.abyss.engine.EmptySoftwareThing;
import com.maehem.abyss.engine.GameState;
import com.maehem.abyss.engine.SoftwareThing;
import com.maehem.abyss.engine.gui.widgets.CooldownIndicator;
import com.maehem.abyss.engine.gui.widgets.Gauge;
import com.maehem.abyss.engine.gui.widgets.NumberIndicator;
...
/**
 * Tab that pops up to represent an attack Software when parked in front of a
 * MatrixSite.
 *
 * @author mark
 */
public class SoftwareTabNode extends BorderPane {
    ...
    public SoftwareTabNode(GameState gameState, SoftwareThing software, char hotKey) {
        ...
        String iconPath = software.getIconPath();
